...
variable "vpc_cidr" {
  ...
  type        = string
  default     = "10.200.0.0/16" # TODO: student supplies
}

variable "public_subnet_cidrs" {
  description = "Public subnet CIDRs (use 10.200.x.x/xx)."
  type        = list(string)
  default     = ["10.200.5.0/24", "10.200.6.0/24"] # TODO: student supplies
}

variable "private_subnet_cidrs" {
  description = "Private subnet CIDRs (use 10.180.x.x/xx)."
  type        = list(string)
  default     = ["10.200.15.0/24", "10.200.16.0/24"] # TODO: student supplies
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "phillipa" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "dailenbout@hotmail.com" # TODO: student supplies
}
